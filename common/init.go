...
func printHelp() {
	fmt.Println("Nox API " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Original Project: OneAPI by JustSong - https://github.com/songquanpeng/one-api")
	fmt.Println("Maintainer: LeoMengTCM - https://github.com/LeoMengTCM/nox-api")
	fmt.Println("Usage: nox-api [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
