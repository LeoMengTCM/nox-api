...
import (
	...
	"github.com/LeoMengTCM/nox-api/dto"
	"github.com/LeoMengTCM/nox-api/logger"
	"github.com/LeoMengTCM/nox-api/relay/channel"
	"github.com/LeoMengTCM/nox-api/relay/channel/ai360"
	"github.com/LeoMengTCM/nox-api/relay/channel/lingyiwanwu"

	//"github.com/LeoMengTCM/nox-api/relay/channel/minimax"
	"github.com/LeoMengTCM/nox-api/relay/channel/openrouter"
	"github.com/LeoMengTCM/nox-api/relay/channel/xinference"
	relaycommon "github.com/LeoMengTCM/nox-api/relay/common"
	"github.com/LeoMengTCM/nox-api/relay/common_handler"
	relayconstant "github.com/LeoMengTCM/nox-api/relay/constant"
	"github.com/LeoMengTCM/nox-api/service"
	"github.com/LeoMengTCM/nox-api/setting/model_setting"
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		header.Set("HTTP-Referer", "https://noxapi.dev")
		header.Set("X-Title", "Nox API")
	}
	return nil
}
