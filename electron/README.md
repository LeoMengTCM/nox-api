# Nox API Electron Desktop App

This directory contains the Electron wrapper for Nox API, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., nox-api-macos)
cp ../nox-api-macos ../nox-api
```
...
- Store database in `../data/nox-api.db`
...
### Database Location
- **Development**: `../data/nox-api.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/Nox API/data/`
  - Windows: `%APPDATA%/Nox API/data/`
  - Linux: `~/.config/Nox API/data/`
