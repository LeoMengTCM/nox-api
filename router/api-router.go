...
import (
	...
	_ "github.com/LeoMengTCM/nox-api/oauth"
...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/user/avatar/:filename", controller.GetAvatar)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/balance/pay", middleware.CriticalRateLimit(), controller.SubscriptionBalancePay)
		}
		...
		casinoRoute.Use(middleware.UserAuth())
		{
			...
			// Bank (古灵阁银行)
			casinoRoute.GET("/bank", controller.GetBankInfo)
			casinoRoute.POST("/bank/deposit", controller.BankDemandDeposit)
			casinoRoute.POST("/bank/withdraw", controller.BankDemandWithdraw)
