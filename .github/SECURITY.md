...
To report a security issue, please use the GitHub Security Advisories tab to "[Open a draft security advisory](https://github.com/LeoMengTCM/nox-api/security/advisories/new)". This is the preferred method as it provides a built-in private communication channel.

Alternatively, you can report via email:

- **Email:** leomengtcm@gmail.com
...
When deploying and using Nox API, we recommend following these security best practices:
