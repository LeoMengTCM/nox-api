...
import (
	...
	"github.com/LeoMengTCM/nox-api/pkg/cachex"
...
const (
	...
	channelAffinityCacheNamespace           = "nox-api:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "nox-api:channel_affinity_usage_cache_stats:v1"
)
